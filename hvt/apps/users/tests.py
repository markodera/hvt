...
class IsSelfOrOrgAdminPermissionTest(TestCase):
    ...
    def test_member_cannot_edit_other_member(self):
        ...
        self.assertFalse(self.permission.has_object_permission(request, None, self.member2))
    ...
    def test_owner_can_edit_anyone(self):
        ...
        self.assertTrue(self.permission.has_object_permission(request, None, self.member1))
        self.assertTrue(self.permission.has_object_permission(request, None, self.admin))
...
class CanChangeRolePermissionTest(TestCase):
    ...
    def test_owner_can_promote_member_to_admin(self):
        ...
        self.assertTrue(self.permission.has_object_permission(request, None, self.member))
    ...
    def test_admin_cannot_promote_to_owner(self):
        ...
        self.assertFalse(self.permission.has_object_permission(request, None, self.member))
    ...
    def test_cross_org_role_change_denied(self):
        ...
        self.assertFalse(self.permission.has_object_permission(request, None, other_member))
...
class RoleUpdateEndpointTest(APITestCase):
    ...
    def test_owner_can_promote_member_to_admin(self):
        ...
        response = self.client.patch(
            f'/api/v1/users/{self.member.id}/role/',
            {'role': 'admin'},
            format='json'
        )
    ...
    def test_member_cannot_change_any_roles(self):
        ...
        response = self.client.patch(
            f'/api/v1/users/{self.admin.id}/role/',
            {'role': 'member'},
            format='json'
        )
