...
class AuditLogAdmin(admin.ModelAdmin):
    list_display = ["created_at", "event_type", "actor_display", "organization", "success", "ip_address"]
    list_filter = ["event_type", "success", "created_at", "organization"]
    search_fields = ["actor_user__email", "ip_address", "event_data"]
    readonly_fields = [
        "id", "event_type", "event_data","actor_user", "actor_api_key",
        "target_content_type", "target_object_id", "organization",
    ...
    def actor_display(self, obj):
        if obj.actor_user:
            return f"User: {obj.actor_user_email}"
